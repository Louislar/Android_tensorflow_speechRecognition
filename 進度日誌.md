...
- 3. (使用DeepSpeech包裝好的generate_trie，不然要自己從bazel build出來) 使用generate_trie將trie檔案生成出來![](https://raw.githubusercontent.com/Louislar/Android_tensorflow_speechRecognition/master/20191013_lm_image03.png)
